...
### 42. Minted: LOL — free mints dumped for dust (2026-07-13)
Every assessment must include "Minted: LOL": NFTs that were minted (from 0x0) and later sold or transferred for less than 0.005 ETH. This catches the free-mint-and-dump pattern — minting something for free, then flipping it for essentially nothing. Calculate by: (1) find all mints from 0x0 to the wallet, (2) find subsequent transfers out of those same (contract, tokenID) pairs, (3) match ETH incoming in the same block as the outgoing NFT, (4) if sell price < 0.005 ETH (or 0 ETH with no matching incoming tx), it's a LOL. Report: total count, percentage of mints dumped, top offending collections, and whether they were dumped same-day. Example: grubnot minted 181 NFTs, 70 (39%) were sold for <0.005 ETH — 13 On-Chain All-Stars dumped at 0 ETH same day.