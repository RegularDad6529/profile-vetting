# @RegularDad — Profile Overview

## 6529 Community
- Level 83 | Rep 2,863,521 | CIC 327,934 | TDH 6,103,664
- PSEUDONYM
- Wave Creator
- Active MS submission: dd54f34b

## Wallets (3 profile + 4 delegated = 7 total)
...
### Delegation Graph
- hot.regulardad.eth → delegates TO memes.regulardad.eth (sub-delegation)
- memes.regulardad.eth → delegates TO regulardad.eth (primary address)
...
## Wave Activity
- 347 active days out of 365 — extremely active
- 3,896 total drops in past year
- 479 drops in last 30 days — daily poster
...
- 207 of 218 collections held are dead (95% — no transfer activity in 90+ days)
- 364 NFTs in dead collections
- 29 collections they PAID to mint, still holding, dead 180+ days — 3.26 ETH spent, current value ~0 ETH
- Worst: DANKBOTS (9 held, paid 0.70 ETH, dead 1416 days / ~4 years)
- SZNS (3 held, paid 0.26 ETH, dead 996 days)
- glitch Gallery (1 held, paid 0.27 ETH, dead 477 days)
- NextGen 6529 (2 held, paid 0.26 ETH, dead 352 days)
- Lumens (1 held, paid 0.21 ETH, dead 347 days)

**Part B — Already dumped for dust:**
- 8 paid-mint NFTs sold for ~0 ETH — 0.58 ETH spent, 0 ETH received
- Worst: SeizerDAO (paid 0.20 ETH → 0 ETH), DANKBOTS (paid 0.12 ETH → 0 ETH)
- 95 free mints also dumped for dust

**Total damage: 3.84 ETH spent minting with 0 ETH recovered on 37 NFTs, plus 364 NFTs still held in dead collections**
